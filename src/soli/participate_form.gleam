...
pub type Participate {
  Participate(name: String, amount_in_cent: Int)
}
...
pub fn create_participate_form() -> Form(Participate) {
  form.new({
    ...
    form.success(Participate(name:, amount_in_cent:))
  })
}
